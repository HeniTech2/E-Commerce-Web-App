...
const Home = () => {
  ...
  // Merge with defaults so nothing is ever undefined
    ...
    <div style={{ fontFamily: t.sfFontFamily || "inherit" }}>
      ...
      <section className="bg-paper2 border-b border-border">
        <div className="max-w-7xl mx-auto px-5 md:px-8 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
          <div>
            {t.heroBadge && (
              <span
                ...
                style={{
                  background: `${t.sfPrimaryColor}18`,
                  color: t.sfPrimaryColor,
                }}
              >
                {t.heroBadge}
              </span>
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <Link
                to="/about"
                className="flex items-center gap-1.5 font-semibold text-sm text-ink hover:opacity-75 transition-opacity"
          ...
          {/* Hero right side: banner image or product grid */}
          {t.heroBannerUrl ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {categories.map((c) => (
            <Link
              ...
              style={{ "--hover-border": `${t.sfPrimaryColor}50` }}
            >
              <span
